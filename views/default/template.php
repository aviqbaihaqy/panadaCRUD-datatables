        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?=$this->location('dashboard') ?>"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Charts<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?= $this->location('flot') ?>">Flot Charts</a>
                            </li>
                            <li>
                                <a href="<?= $this->location('morris') ?>">Morris.js Charts</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?= $this->location('tables') ?>">Tables</a>
                            </li>
                            <li>
                                <a href="<?= $this->location('datatables') ?>">Dynamic Datatables</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="<?= $this->location('forms') ?>"><i class="fa fa-edit fa-fw"></i> Forms</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-wrench fa-fw"></i> UI Elements<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href=" <?= $this->location('panels-wells') ?>">Panels and Wells</a>
                            </li>
                            <li>
                                <a href=" <?= $this->location('buttons') ?>">Buttons</a>
                            </li>
                            <li>
                                <a href=" <?= $this->location('notifications') ?>">Notifications</a>
                            </li>
                            <li>
                                <a href=" <?= $this->location('typography') ?>">Typography</a>
                            </li>
                            <li>
                                <a href=" <?= $this->location('grid') ?>">Grid</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href=" <?= $this->location('blank') ?>">Blank Page</a>
                            </li>
                            <li>
                                <a href=" <?= $this->location('login') ?>">Login Page</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
